      ...
      <form @submit.prevent="handleSubmit">
        ...
        <div class="inputDiv">
          ...
          <img v-if="product.img" 
              :src="product.img" style="width:100%; margin-top:10px; border-radius:5px;" 
          />
        </div>
        ...
        <div class="inputDiv">
          ...
          <textarea
            ...
            v-model="product.productDetails"
          ></textarea>
        </div>
        ...
        <div class="inputDiv" v-for="(img, index) in 4" :key="index">
          ...
          />
          <img v-if="product.imgGroup[index]" 
              :src="product.imgGroup[index]" 
...
const handleImageUpload = (event) => {
  ...
  reader.onload = (e) => { product.value.img = e.target.result }
...
const handleAccessoryUpload = (event, index) => {
  const file = event.target.files[0]
  const reader = new FileReader()
  reader.onload = (e) => { product.value.imgGroup[index] = e.target.result }
  reader.readAsDataURL(file)
}
